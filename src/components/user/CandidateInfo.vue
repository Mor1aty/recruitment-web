        ...
        <div>
          ...
          <el-card class="job-card box-card">
            <div slot="header" class="clearfix">
              ...
              <el-button type="text" class="button" style="float: right;color: rgb(93, 213, 200)">添加</el-button>
            </div>
            <div>
              <div v-for="item in user.expectedPositionList" :key="item.id" :value="item.id" style="width: 100%;">
                ...
                <el-button type="text" class="button" style="color: rgb(93, 213, 200)">删除</el-button>
              </div>
            </div>
          </el-card>
          <el-divider></el-divider>
          <el-card class="job-card box-card">
            ...
            <div>
              <div v-for="item in user.workExperienceList" :key="item.id" :value="item.id" style="width: 100%;">
                <el-button type="text" class="button" style="float:right;color: rgb(93, 213, 200)">删除</el-button>
